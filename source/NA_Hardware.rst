...
:fas:`person` Human Behavioural Hardware
===========================================
...
:fa:`paw` Animal Behavioural Hardware
========================================
...
.. card-carousel:: 3
  ...
  .. card::
    ...
    :class-body: sd-bg-dark
    :class-footer: sd-bg-dark
    :img-top: _images/Designs/MIDAS/FreeCAD_MiniDrive.jpeg
    :class-card: sd-border-1 sd-outline-light

    **MIDAS**

    ^^^^^^^^^^^^
    Multidrive Implant Designer for Accurate Stereotaxy
